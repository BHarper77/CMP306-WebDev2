...
<html lang = "en">
	...
	<body>
		...
		<?php
		global $conn;
		$query = mysqli_query($conn, "SELECT ArticleTitle, Author, Text FROM Articles WHERE ArticleNo = '2002'");
		...
		$query2 = mysqli_query($conn, "SELECT Images.ImagePath
									  ...
									  INNER JOIN Articles
									  ON RelatedImagesArticles.ArticleNo = Articles.ArticleNo WHERE Articles.ArticleNo = '2002'");
