...
<html lang = 'en'>
    ...
    <body>
        ...
        <a href="RSSFeed.php"><img class="img-fluid float-left" src="../Images/RSS.png" style="height: 20px; width: 20px;"></a>
        <br>
        <a href="externalRSS.php"><img class="img-fluid float-left" src="../Images/RSS.png" style="height: 20px; width: 20px;">F1 Autosport</a>
